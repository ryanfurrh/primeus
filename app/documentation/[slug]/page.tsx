...
const PostPage = (props: any) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full px-4 font-mono text-pale-100">
      <div className="flex flex-col md:flex-row ">
        ...
        <div className="w-full h-full px-4 pt-4 md:p-0">
          ...
          <article className="flex h-full prose-sm prose dark:text-ink-50 text-sand-900 ">
            <Markdown
              options={{
                overrides: {
                  h2: {
